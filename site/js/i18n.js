...
(function () {
  ...
  var STR = {
    zh: {
      ...
      // 作品集(8.3)
      ppTabWorks: "作品",
      wkUpTitle: "上传作品", wkUpNote: "1–9 张图片,提交后经人工审核通过才会公开展示。",
      ...
      wkDone: "已提交!人工审核通过后会出现在你的主页", wkEmpty: "还没有公开作品",
    ...
    en: {
      ...
      // Portfolio (8.3)
      ppTabWorks: "Works",
      wkUpTitle: "Upload work", wkUpNote: "1–9 images. Published after human review.",
      ...
      wkDone: "Submitted! It will appear on your page once approved.", wkEmpty: "No public works yet",
