...
(function () {
  ...
  var STR = {
    zh: {
      ...
      sfPhDeadline: "截止日期(选填,格式 2026-12-31)", sfPhUrl: "官网链接(必填,https:// 开头,请填主办方自己的网站)",
      ...
      sfErrUrl: "请填写 http(s):// 开头的官网链接", sfErrDate: "截止日期格式:2026-12-31",
    ...
    en: {
      ...
      sfPhDeadline: "Deadline (optional, 2026-12-31)", sfPhUrl: "Official site URL (required, https://, the organizer's own site)",
      ...
      sfErrUrl: "A valid http(s):// official link is required", sfErrDate: "Deadline format: 2026-12-31",
