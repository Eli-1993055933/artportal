...
(function () {
  ...
  var STR = {
    zh: {
      ...
      cat_all: "全部", cat_opencall: "展览征集", cat_residency: "驻留项目", cat_award: "艺术奖项", cat_workshop: "工作坊",
    ...
    en: {
      ...
      cat_all: "All", cat_opencall: "Open Calls", cat_residency: "Residencies", cat_award: "Awards", cat_workshop: "Workshops",
